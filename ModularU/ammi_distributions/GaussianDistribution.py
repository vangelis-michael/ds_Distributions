...
class Gaussian(Distribution):
    ...
    Attributes:
        ...
        stdev (float) representing texhe standard deviation of the distribution
    ...
    #We keep the read data file because we want it to override the readdata file method from the distribution class
    ...
    def read_data_file(self, filename, sample=True):
        ...
        Args:
            ...
            sample (bool): If distribution is sample or population
